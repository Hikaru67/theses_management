<template>
  <div class="box-overview">
    <a-row type="flex" :gutter="30" class="list">
      <a-col :span="24" :sm="12" :lg="6" class="item item-green mb-3">
        <div class="box-item">
      ...
      <a-col :span="24" :sm="12" :lg="6" class="item item-blue mb-3">
        <div class="box-item">
          <div class="box-detail">
            <a-row type="flex" :gutter="30">
              <a-col flex="auto">
      ...
      <a-col :span="24" :sm="12" :lg="6" class="item item-yellow mb-3">
        <div class="box-item">
          <div class="box-detail">
            <a-row type="flex" :gutter="30">
              <a-col flex="auto">
      ...
      <a-col :span="24" :sm="12" :lg="6" class="item item-red mb-3">
        <div class="box-item">
          <div class="box-detail">
            <a-row type="flex" :gutter="30">
              <a-col flex="auto">
